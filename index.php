...
<body class="body p-2">
  ...
  <div class="container">
    ...
    <div class="alert alert-success alert-dismissible" role="alert">
      <strong>Hello reader!</strong> If you want to be up to date every day, then sign up for our newsletter! <a href="register.html" class="alert-link">Sign up here!</a>
